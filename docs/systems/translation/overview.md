...
- `json-autotranslate`: CLI for sending strings to the translation service and writing translations back to the JSON files
...
5. Runs `yarn l10n:auto-translate`, which runs `json-autotranslate`
