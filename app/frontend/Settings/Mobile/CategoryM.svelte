...
<script lang="ts">
  ...
  import { SetupJackdawApp } from "../../Setup/SetupJackdawApp";
  import { appGlobal } from "../../../logic/app";
  import { goTo, apps } from "../../AppsBar/selectedApp";
  ...
  $: subCategories = category
    ...
    : settingsCategories.filterObservable(cat => cat.isMain && (!cat.forApp || apps.includes(cat.forApp)));
  ...
  function onNewAccount() {
    ...
    let setupApp = new SetupJackdawApp();
