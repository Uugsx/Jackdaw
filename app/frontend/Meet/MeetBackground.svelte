...
<script lang="ts">
  ...
  import { openApp, selectedApp, apps } from "../AppsBar/selectedApp";
  ...
  $: meetApp.showSidebar = $meetings.hasItems && $selectedApp != meetApp && !window.location.pathname.startsWith("/meet");
