<vbox class="results" flex>
  {#if searchMessages}
    <VerticalMessageList messages={searchMessages} emptyDueToFilter={!!searchMessages} bind:selectedMessage bind:selectedMessages on:click={() => catchErrors(goToMessage)} />
