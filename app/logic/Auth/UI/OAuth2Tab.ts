...
import type { LoginDialogJackdawApp } from "../../../frontend/Mail/MailJackdawApp";
...
export class OAuth2Tab extends OAuth2UI {
  ...
  launcherApp: LoginDialogJackdawApp;
  ...
  async login(): Promise<string> {
    ...
    assert((oAuth2TabsOpen as any)._observers.size, "OAuth2 tab: Observer got lost"); // mailApp.tabsObserver is gone
