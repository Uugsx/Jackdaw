...
export class Event extends Observable {
  ...
  isOnline = false;
  /**
   * Exchange LegacyFreeBusyStatus: Busy, Free, Tentative, OOF, WorkingElsewhere.
   * Round-tripped on OWA/EWS save; UI may expose later.
   */
  @notifyChangedProperty
  freeBusyStatus: "Busy" | "Free" | "Tentative" | "OOF" | "WorkingElsewhere" = "Busy";
  /** Exchange Sensitivity == Private */
  @notifyChangedProperty
  isPrivate = false;
  ...
  protected copyFromRecurrenceMaster(original: Event) {
    ...
    this.freeBusyStatus = original.freeBusyStatus;
